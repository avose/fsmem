...
// !!av: I will "hook" into the ptmalloc code by using
//       the "morecore" interface.  It also looks like I may
//       have to add support for fsmem_mmap() as well...
//       ATM, I don't remap malloc(), but I do remap mmap().
#define FSMEM_NOMALLOCREMAP
#include "../fsmem.h"


// !!av: mmap() / munmap() is not used consistently in this file.
//       These remappings try to clean it up (MAP_PRIVATE, a wrapped
//       MMAP but an unmapped munmap(), etc).
#undef  MAP_PRIVATE
#define MAP_PRIVATE           MAP_SHARED
#define HAVE_MMAP             0
#define HAVE_MREMAP           0
#define MMAP_CLEARS           0

#define HAVE_MORECORE         1
#define MORECORE              fsmem_sbrk
